...
/* 宏定义说明：GZ2_LED1_TOGGLE，GZ2_LED1_TOGGLE宏定义，用于保持PB7 LED翻转。 */
#define GZ2_LED1_TOGGLE GPIO_TogglePin(GPIOB, GPIO_PIN_7)
...
/* 宏定义说明：F9_RD，F9_RD宏定义，用于保持原工程风格并集中配置相关参数。 */
#define F9_RD gpio_input_bit_get(GPIOA, GPIO_PIN_6)
