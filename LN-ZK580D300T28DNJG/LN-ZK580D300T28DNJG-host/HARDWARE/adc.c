...
void Adc_Init(void)
{
    ...
    adc_regular_channel_config(ADC0, 1, ADC_CHANNEL_7, ADC_SAMPLETIME_55POINT5); // PA7 - 12V电流
    adc_regular_channel_config(ADC0, 2, ADC_CHANNEL_5, ADC_SAMPLETIME_55POINT5); // PA5 - 12V电压
    adc_regular_channel_config(ADC0, 3, ADC_CHANNEL_6, ADC_SAMPLETIME_55POINT5); // PA6 - 28V电流
    adc_regular_channel_config(ADC0, 4, ADC_CHANNEL_4, ADC_SAMPLETIME_55POINT5); // PA4 - 28V电压
    adc_regular_channel_config(ADC0, 5, ADC_CHANNEL_1, ADC_SAMPLETIME_55POINT5); // PA1 - 输入电流
    adc_regular_channel_config(ADC0, 6, ADC_CHANNEL_0, ADC_SAMPLETIME_55POINT5); // PA0 - 输入电压
