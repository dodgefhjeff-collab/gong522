...
#define EN_12V_KZ_ON    gpio_bit_set(GPIOA, GPIO_PIN_15)
#define EN_12V_KZ_OFF   gpio_bit_reset(GPIOA, GPIO_PIN_15)

#define EN_F28V_KZ_ON   gpio_bit_set(GPIOB, GPIO_PIN_4)
#define EN_F28V_KZ_OFF  gpio_bit_reset(GPIOB, GPIO_PIN_4)

#define EN_28V_KZ_ON    gpio_bit_set(GPIOB, GPIO_PIN_3)
#define EN_28V_KZ_OFF   gpio_bit_reset(GPIOB, GPIO_PIN_3)
